...
def retrieval_eval(model, ref_model, data_loader, tokenizer, device, args, config):
    ...
    for images, texts, texts_ids in data_loader:
        ...
        with torch.no_grad():
            ...
            output = model.inference(images, texts_input)
...
if __name__ == '__main__':
    ...
    #target model
    parser.add_argument('--target_model', default='ALBEF', choices=['ALBEF', 'CLIP', 'CLIP', 'BLIP'])
    ...
    parser.add_argument('--target_dataset', default='mscoco', choices=['mscoco', 'flickr30'])    
    parser.add_argument('--method', default='your attack model name')
